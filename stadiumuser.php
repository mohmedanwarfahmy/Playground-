<?php include 'headerusercancelstyle.php';
  session_start();
...
<body>
           ...
           <center>
                     ...
                     <form action="" method="POST"> 
                            ...
                            <input type="number" id="phone" name="phone"  min="2021-01-01" max="2021-12-31"/> <br/>             
                       ...
                       $db = mysqli_select_db($connection,'stadium');
                        if(isset($_POST['search']))
                        {
                         //$product_id = $_SESSION["product_id"];
                          $date = $_POST['date'];
                          $phone = $_POST['phone'];
                           $query = "SELECT * FROM booking WHERE `date`='$date' AND `phone`='$phone'  ";
