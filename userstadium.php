...
<body>
           ...
           <center>
                     ...
                     <form action="" method="POST"> 
                            ...
                            <input type="el" id="phone" name="phone" placeholder="Enter the phone number"><br/>

                                <input type="mail" id="email" name="email" placeholder="Enter the E_mail"><br/>

                                <input type="full"  id="full_name" name="full_name" placeholder="Enter the full_name "><br/>
                        ...
                        if(isset($_POST['search']))
                        {
                         //$product_id = $_SESSION["product_id"];
                          ...
                          $full_name = $_POST['full_name'];
                           ...
                           $query = "SELECT * FROM booking WHERE `date`='$date' AND `phone`='$phone' AND `email`='$email' AND `full_name`='$full_name' ";
 ...
 <!---****************************************************************************************************************************************-->
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Confirm the booking</h5>
            ...
            <div class="modal-body">
                      ...
                      <h4> Do you want to Confirm this Data  ??</h4>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"> NO </button>
                        <a  class="btn btn-primary" href="#?id=<?php echo $row['id'];?>">Yes !! Confirm it.</a>
                      </div>
                      </div>
                      </div>
                      </div>
 ...
 <!---****************************************************************************************************************************************-->
            ...
            <form action="delete.php" method="POST">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"> NO </button>
                    <a  class="btn btn-primary" href="cancelbooking2.php?id=<?php echo $row['id'];?>">Yes !! Delete it.</a>
                  </div>
                </div>
              </div>
            </div>
